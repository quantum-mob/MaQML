(* -*- mode:math -*- *)
(* $Date: 2023-07-16 22:05:26+09 $ *)
(* $Revision: 1.3 $ *)

Get["Q3`"];
Q3Assure["2.13.4"]

BeginPackage["MaQML`", {"Q3`"}]

Unprotect["`*"];
ClearAll["`*"];

`MaQML`$Version = StringJoin[
  "Q3/", $Input, " v",
  StringSplit["$Revision: 1.3 $"][[2]], " (",
  StringSplit["$Date: 2023-07-16 22:05:26+09 $"][[2]], ") ",
  "Mahn-Soo Choi"
 ];
...
$symbs = Unprotect[Multiply, $ElaborationPatterns]
